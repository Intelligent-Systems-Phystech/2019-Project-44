...
\subfloat[Адекватная избыточная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/adequate_redundant_sample_llh.pdf}}\\
\end{tabular}

\caption{Зависимость значения функции $e^{-S_{\text{reg}}(m, n)}$ от объема выборки $m$ и количества параметров $n$}
\label{fig100}
\end{figure}

На рис. 3 представлена аппроксимация $\phi(p, \hat{A}(m, n), m, n) \sim e^{-S_{\text{reg}}(m, n)}$ при $m_0 = 50$.

\begin{figure}[h!t]\center
\centering\begin{tabular}{@{}c@{ }c@{ }c@{}}
\subfloat[Адекватная случайная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/adequate_random_sample_llh_phi.pdf}}&
\subfloat[Адекватная скоррелированная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/adequate_correlated_sample_llh_phi.pdf}}\\
\subfloat[Адекватная ортогональная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/adequate_orthogonal_sample_llh_phi.pdf}}&
\subfloat[Адекватная избыточная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/adequate_redundant_sample_llh_phi.pdf}}\\
\end{tabular}

\caption{Аппроксимация  $\phi(m, n) \sim e^{-S_{\text{reg}}(m, n)}$}
\label{fig101}
\end{figure}
...
\caption{Зависимость значения функции $MAPE(\phi(m, n), e^{-S_{\text{reg}}(m, n)})$ от объема выборки $m_0$}
\label{fig102}
\end{figure}
...
Получились следующие значения $m_0, n$ для различных конфигураций выборок:

\begin{enumerate}
	\item Адекватная случайная выборка: $m_0 = 16, n = 10$.
	\item Адекватная скоррелированная выборка: $m_0 = 3, n = 2$.
	\item Адекватная ортогональная выборка: $m_0 = 11, n = 10$.
	\item Адекватная избыточная выборка: $m_0 = 7, n = 5$.
\end{enumerate}
...
\subfloat[Адекватная избыточная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/adequate_redundant_sample_MAPE_m_comparison_n7.pdf}}\\
\end{tabular}

\caption{Зависимость значения функции $MAPE(m^*_{\text{pred}}, m^*)$ от объема выборки $m_0$}
\label{fig103}
\end{figure}
