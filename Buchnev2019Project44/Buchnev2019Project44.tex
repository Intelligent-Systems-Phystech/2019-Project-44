...
\subfloat[Адекватная случайная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/theoretical_adequate_random_sample_llh.pdf}}&
\subfloat[Адекватная скоррелированная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/theoretical_adequate_correlated_sample_llh.pdf}}\\
\subfloat[Адекватная ортогональная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/theoretical_adequate_orthogonal_sample_llh.pdf}}&
\subfloat[Адекватная избыточная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/theoretical_adequate_redundant_sample_llh.pdf}}\\
\subfloat[Недекватная скоррелированная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/theoretical_inadequate_correlated_sample_llh.pdf}}&\\
\end{tabular}
...
\begin{figure}[h!t]\center
\centering\begin{tabular}{@{}c@{ }c@{ }c@{}}
\textbf{С использованием $\hat{A}(m, n)$} & \textbf{Без использования $\hat{A}(m, n)$}\\
\subfloat[Адекватная случайная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/theoretical_adequate_random_sample_llh_phi.pdf}}&
\subfloat[Адекватная случайная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/exploitational_adequate_random_sample_llh_phi.pdf}}\\
\subfloat[Адекватная скоррелированная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/theoretical_adequate_correlated_sample_llh_phi.pdf}}&
\subfloat[Адекватная скоррелированная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/exploitational_adequate_correlated_sample_llh_phi.pdf}}\\
\subfloat[Адекватная ортогональная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/theoretical_adequate_orthogonal_sample_llh_phi.pdf}}&
\subfloat[Адекватная ортогональная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/exploitational_adequate_orthogonal_sample_llh_phi.pdf}}\\
\subfloat[Адекватная избыточная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/theoretical_adequate_redundant_sample_llh_phi.pdf}}&
\subfloat[Адекватная избыточная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/exploitational_adequate_redundant_sample_llh_phi.pdf}}\\
\end{tabular}
...
\begin{figure}[h!t]\center
\centering\begin{tabular}{@{}c@{ }c@{ }c@{}}
\subfloat[Адекватная избыточная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/theoretical_inadequate_correlated_sample_llh_phi.pdf}}&
\subfloat[Адекватная избыточная выборка]{\includegraphics[width=0.5\textwidth]{../data/pics/exploitational_inadequate_correlated_sample_llh_phi.pdf}}\\
\end{tabular}
